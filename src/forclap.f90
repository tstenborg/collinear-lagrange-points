...
!
! ForCLaP contains Fortran 2003 updates to the Fortran 95 program described in:
!
! T. N. Stenborg, "Collinear Lagrange Point Solutions in the Circular
! Restricted Three-Body Problem with Radiation Pressure using Fortran", in
! Astron. Data Anal. Softw. Syst. XVII, in Astronomical Society of the Pacific
! Conference Series, vol. 394, R. W. Argyle, P. S. Bunclark and J. R. Lewis,
! Eds., 2008, pp. 734–737.
